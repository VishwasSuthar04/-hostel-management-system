...
if (isset($_POST['update_status'])) {
    ...
    if ($stmt->execute()) {
        setMessage("Fee status updated successfully!", "success");
    }
    redirect('fees.php');
}
...
$fees = [];
$result = $conn->query("SELECT f.*, s.student_name, s.father_name, r.room_number 
                        FROM fees f 
...
// Get all students for adding new fee
...
<head>
    ...
    <title>Fees - Hostel Management System</title>
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar p-0">
                ...
                <ul class="nav flex-column mt-3">
                    ...
                    <li class="nav-item"><a href="fees.php" class="nav-link active"><i class="fas fa-money-bill"></i> Fees</a></li>
                                    ...
                                    <?php if (count($fees) > 0): ?>
                                        <?php foreach ($fees as $fee): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $fee['room_number'] ? $fee['room_number'] : '-'; ?></td>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#updateStatusModal<?php echo $fee['id']; ?>">
                                            ...
                                            <!-- Update Status Modal -->
                                            <div class="modal fade" id="updateStatusModal<?php echo $fee['id']; ?>" tabindex="-1">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" name="status">
                                                                        ...
                                                                        <option value="rejected" <?php echo $fee['status'] == 'rejected' ? 'selected' : ''; ?>>Rejected</option>
                                                                    </select>
                                                                </div>
                                                            </div>
    ...
    <div class="modal fade" id="addFeeModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="add_fee.php" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="student_id" required>
                                ...
                                <?php foreach ($students as $student): ?>
                                    <option value="<?php echo $student['id']; ?>">
                                        <?php echo htmlspecialchars($student['student_name']); ?> - <?php echo $student['father_name']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Payment Proof (JPG, PNG - Max 2MB)</label>
                            <input type="file" class="form-control" name="payment_proof" accept=".jpg,.jpeg,.png">
                        </div>
                    </div>
                    <div class="modal-footer">
