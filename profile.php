...
<head>
    ...
    <style>
        ...
        .profile-card { background: white; border-radius: 15px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.05); }
    </style>
</head>
<body>
        ...
        <div class="row">
            <div class="col-md-2 sidebar p-0">
                ...
                <ul class="nav flex-column mt-3">
                    ...
                    <li class="nav-item"><a href="profile.php" class="nav-link active"><i class="fas fa-user"></i> My Profile</a></li>
            ...
            <div class="col-md-10 p-0">
                ...
                <div class="p-4">
                    <h4 class="mb-4"><i class="fas fa-user"></i> My Profile</h4>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="profile-card p-4 text-center">
                                ...
                                <p class="text-muted"><?php echo $room ? $room['room_number'] : 'No Room Assigned'; ?></p>
                            ...
                            <div class="profile-card p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="fw-bold"><?php echo htmlspecialchars($student['student_name']); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Father Name</label>
                                        <p class="fw-bold"><?php echo htmlspecialchars($student['father_name']); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">CNIC</label>
                                        <p class="fw-bold"><?php echo htmlspecialchars($student['cnic']); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Phone</label>
                                        <p class="fw-bold"><?php echo htmlspecialchars($student['phone']); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Email</label>
                                        <p class="fw-bold"><?php echo htmlspecialchars($student['email'] ?? 'N/A'); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Address</label>
                                        <p class="fw-bold"><?php echo htmlspecialchars($student['address'] ?? 'N/A'); ?></p>
                                    </div>
                                </div>
                                
                                <h5 class="mb-4 border-bottom pb-2 mt-4">Hostel Information</h5>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Room Number</label>
                                        <p class="fw-bold"><?php echo $room ? $room['room_number'] : 'Not Assigned'; ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Room Type</label>
                                        <p class="fw-bold"><?php echo $room ? ucfirst($room['room_type']) : 'N/A'; ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Bed Number</label>
                                        <p class="fw-bold"><?php echo $student['bed_number'] ?? 'N/A'; ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Monthly Fee</label>
                                        <p class="fw-bold">₹<?php echo number_format($student['monthly_fee'], 2); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted">Entry Date</label>
                                        <p class="fw-bold"><?php echo date('d M Y', strtotime($student['entry_date'])); ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
